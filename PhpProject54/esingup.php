    ...
    <body>
        <div class="main_wrapper">
          ...
          if (isset($_GET['signup'])) {
                $error = $_GET['signup'];
                if ($error == 'empty'){
                    echo "Please fill out all of the inputs!";
                } else {
